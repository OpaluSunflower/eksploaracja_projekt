...
Poniższa analiza dotyczy parametrów samochodów osobowych, wystawionych na sprzedaż za pośrednictwem portalu internetowego <a href="https://www.otomoto.pl/"> otomoto.pl</a> z okolic Lublina (w promieniu 50 km).
...
-   **Typ_nadwozia:**
    ...
    2.  **Kombi**: Jest to samochód osobowy ze względu na swoją elastyczność i przestronność. Zazwyczaj ma cztery drzwi, kontur i szerokie tylne siedzenia.

    3.  **Hatchback(auta miejskie)**: Samochód osobowy z drzwiami tylnymi i konturem. Jest to wygodny wybór dla osób, które często transportują duże ilości bagażu.
...
Zgodnie z przyjętym standardem usuwamy ze zbioru w poszczególnych kolumnach wartości, które nie znajdują się między pierwszym a trzebim kwantylem (Q1 -1.5IQR, Q3+1.5IQR)
...
Nie powinna dziwić wysoka korelacja między mocą silnika a pojemnością skokową. Może ona jednal być niekorzystna w dalszym przetwarzaniu. Dlatego zbudujemy dwa modele, w których wykorzystamy zbiór danych bez jednej z tych cech.
